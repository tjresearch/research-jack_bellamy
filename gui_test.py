...
dirname =""
filename="/home/jbellamy/Desktop/Senior Lab Project/Test Images/04280001.JPG"
w, h = 400,400
...
st.set("Label: ")
open_img=Button(f,text="Open Image",command= lambda: find_file(c,st))
